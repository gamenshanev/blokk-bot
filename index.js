...
bot.on("ready", async () => {
    ...
    bot.user.setActivity(`Blokk Community`, { type: "WATCHING" });
	
	    bot.on("guildMemberAdd", member => {
        var role = member.guild.roles.find("name", "▪️ | Member"); 
        if (!role) return;
        member.addRole(role);
        ...
        var joinEmbed = new discord.RichEmbed()
            ...
            .setDescription(`Hoi ${member.user.username}, Welkom op **Blokk Community** Discord Server.`)
            .setColor("#00FF00")
            .setTimestamp()
